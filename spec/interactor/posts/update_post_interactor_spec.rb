# spec/interactors/posts/update_post_interactor_spec.rb
  ...
  describe '#call' do
    context 'with a valid user and valid post_params' do
      it 'updates the post' do
        interactor = described_class.call(user:, post_params: valid_post_params, id: post.id)
    ...
    context 'with an invalid user' do
      it 'fails and sets an error message' do
        ...
        interactor = described_class.call(user: other_user, post_params: valid_post_params, id: post.id)
